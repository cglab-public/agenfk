...
**Exception**: Project-scoped release commands (defined in a repo's own `.claude/commands/`) are exempt from the active task requirement. Do not create or require a task when executing them.
